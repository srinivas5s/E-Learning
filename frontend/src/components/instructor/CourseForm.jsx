...
const CourseForm = ({ initial = {}, isEdit = false, onSubmit, onCancel, saving = false }) => {
    ...
    const hasDiscount = form.price > 0 && form.discountPrice > 0 && form.discountPrice < form.price;
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-6">
            ...
            >
                <p className="text-xs text-center sm:text-left"
                    style={{ color: "var(--color-text-muted)" }}>
                    {isEdit ? (
                        <>Changes are saved immediately and reflected to students.</>
                    ) : (
                        <>
